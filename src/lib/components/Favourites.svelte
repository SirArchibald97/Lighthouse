...
<div class="flex flex-col px-4 sm:px-24 2xl:px-96 py-4 sm:py-8">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 *:bg-neutral-300/50 *:dark:bg-neutral-800/50 *:shadow-xl *:duration-100">
        <a href="/player/SirArchibald97" class="flex flex-row justify-center gap-x-2 p-4 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-800">
            <div class="flex flex-col justify-center items-center gap-y-3">
                ...
                <div class="flex flex-row gap-x-2">
                    ...
                    <p class="text-neutral-900 dark:text-neutral-100 text-center text-sm md:text-lg font-semibold self-center">SirArchibald97</p>
                </div>
            </div>
        </a>
        ...
        {#each data.profiles as profile}
            <a href={`/player/${profile.username}`} class="flex flex-row justify-center gap-x-2 p-4 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-800">
                <div class="flex flex-col justify-center items-center gap-y-3">
