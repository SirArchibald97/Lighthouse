...
<div class="flex-1 flex flex-col gap-y-8 text-neutral-900 dark:text-neutral-100">
    
    <div class="flex flex-col gap-y-2">
        <p class="text-3xl sm:text-4xl font-semibold m-2 sm:m-4 text-center">Openable Simulator</p>
        <div class="border border-neutral-300 dark:border-neutral-800 rounded-sm p-4 sm:self-start w-full">
            <div class="flex flex-col sm:flex-row gap-x-4 gap-y-2 sm:gap-y-0">
                ...
                <div class="flex flex-row gap-x-4 gap-y-2 sm:gap-y-0">
                    ...
                    <button on:click={open} class="flex flex-row text-lg rounded-md bg-red-500 py-1.5 px-5 text-slate-50 shadow-sm hover:bg-red-500/70">
                        Open
                    </button>
                </div>
            ...
            <div class="mt-4">
                ...
                {:else}
                    <p class="text-center text-xl font-semibold my-8">Open something first...</p>
                {/if}
            </div> 
        </div>
    </div>
