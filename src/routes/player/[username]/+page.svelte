                                ...
                                <div class="flex flex-col items-start bg-slate-100 rounded-md border-2 border-slate-200 p-3">
                                    ...
                                    {#if expandedCategory === "db"}
                                        <div class="grid grid-cols-1 sm:grid-cols-3 items-start gap-y-4 mt-2 text-md gap-x-24">
                                            ...
                                            <div>
                                                <p>Survived 1 Minute: <span class="font-semibold">{(data.player.statistics.dynaball.survive_1m - data.player.statistics.dynaball.survive_2m).toLocaleString()}</span> <span class="text-slate-500">({Math.round(((data.player.statistics.dynaball.survive_1m - data.player.statistics.dynaball.survive_2m) / data.player.statistics.dynaball.games_played) * 100)}%)</span></p>
                                                <p>Survived 2 Minutes: <span class="font-semibold">{(data.player.statistics.dynaball.survive_2m - data.player.statistics.dynaball.survive_3m).toLocaleString()}</span> <span class="text-slate-500">({Math.round(((data.player.statistics.dynaball.survive_2m - data.player.statistics.dynaball.survive_3m) / data.player.statistics.dynaball.games_played) * 100)}%)</span></p>
                                                <p>Survived 3 Minutes: <span class="font-semibold">{(data.player.statistics.dynaball.survive_3m - data.player.statistics.dynaball.survive_4m).toLocaleString()}</span> <span class="text-slate-500">({Math.round(((data.player.statistics.dynaball.survive_3m - data.player.statistics.dynaball.survive_4m) / data.player.statistics.dynaball.games_played) * 100)}%)</span></p>
