...
<div class="flex flex-col gap-y-4 flex-1 my-4 text-neutral-900 dark:text-neutral-100">
    <p class="text-center text-4xl font-semibold mx-4 mb-4 sm:mx-44">Leaderboards</p>
