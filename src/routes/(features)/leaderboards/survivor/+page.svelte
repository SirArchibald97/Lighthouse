<script>
    ...
    let stats = [
        { name: "Wins", value: "statistics.pkw.survivor.wins" },
        { name: "Losses", value: "statistics.pkw.survivor.losses" },
        { name: "WLR", value: "statistics.pkw.survivor.wlr" },
        { name: "Players Outlived", value: "statistics.pkw.survivor.kills" },
        { name: "Obstacles Completed", value: "statistics.pkw.survivor.obstacles" },
    ];
</script>
